                            ...
                            <tbody>
          					<c:forEach var="pais" items="${lista }">
                                       <tr>
                                            ...
                                            <td class="actions">
                                                <a class="btn btn-success btn-xs" href="ManterPais.do?acao=Visualizar&id=${pais.PaisId }">Visualizar</a>
                                                <a class="btn btn-warning btn-xs" href="ManterPais.do?acao=Editar&id=${pais.PaisId }">Editar</a>
                                                <button id="btn${pais.PaisId}%>" type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delete-modal" data-cliente="${pais.Paisid }">Excluir</button>
                                            </td>
                                        </tr>
                            </c:forEach>
